...
export default function CreatePropertyScreen() {
  ...
  const handleSubmit = async () => {
    ...
    if (!selectedLandlord) {
      Alert.alert('Required Field', 'Please select a Landlord for this property.');
      return;
    }
    ...
    try {
      ...
      const msg = err.response?.data?.message || (err.response?.data?.errors && err.response.data.errors[0]) || 'Failed to create property.';
    ...
    >
      ...
      >
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              <Text style={[styles.pickerValueText, !selectedLandlord && { color: '#94a3b8' }]}>
                {selectedLandlord ? selectedLandlord.fullName : 'Tap to choose landlord...'}
              </Text>
            </View>
        ...
        <View style={styles.card}>
          ...
          <TextInput
            style={styles.input}
            placeholder="e.g. Shop 1, 142 High Street"
        ...
        <View style={styles.card}>
          ...
          <TextInput
            style={styles.input}
            placeholder="e.g. 142 High Street"
            placeholderTextColor="#94a3b8"
            value={address}
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.subLabel}>Upload photos directly to Cloudinary storage.</Text>
        ...
        <View style={styles.card}>
          ...
          <TextInput
            ...
            placeholder="Features, amenities, condition..."
            placeholderTextColor="#94a3b8"
            multiline
            numberOfLines={3}
            value={description}
          ...
          <TextInput
            style={[styles.input, styles.multilineInput]}
            placeholder="Access codes, key location, private notes..."
            placeholderTextColor="#94a3b8"
            multiline
            numberOfLines={2}
            value={notes}
            ...
            <ScrollView style={{ maxHeight: 340 }}>
              ...
              {filteredLandlords.length === 0 && (
                <View style={{ padding: 24, alignItems: 'center' }}>
                  <Text style={{ color: '#94a3b8' }}>No landlords found</Text>
                </View>
              )}
            </ScrollView>
          </View>
